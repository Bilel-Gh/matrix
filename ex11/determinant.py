...
class MatrixWithDeterminant(Matrix):
    ...
    def det_3x3(self, matrix) -> float:
        """
        Calcule le déterminant d'une matrice 3x3 en
         utilisant la règle de Sarrus.
        """
        a = matrix[0][0]
        b = matrix[0][1]
        c = matrix[0][2]
    ...
    def determinant(self) -> float:
        ...
        if size == 1:
            ...
            raise ValueError(
                "Cette implémentation ne gère que les matrices jusqu'à 4x4")
