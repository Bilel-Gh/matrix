...
import ex11.determinant
import ex10.row_echelon

def inverse(self) -> 'Matrix':
    """
    Calcule l'inverse de la matrice en utilisant la méthode de Gauss-Jordan.
    La méthode fonctionne en créant une matrice augmentée [A|I] puis en la réduisant
    pour obtenir [I|A^(-1)].
    """
